...
# This is the favourite way to process search results for langchain (although optional)
# Use HTTPX client -> read url -> convert to md -> return process results
...
# This is a no-opt tool, nothing happens here. It is an opportunity for the model to stop and reflect,
# enforcing that behaviour. It has been proven by Anthropic that interleaved thinking can improve performance.
@tool(parse_docstring=True)
